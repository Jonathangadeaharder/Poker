...
declare module '$env/static/private' {
	...
	export const npm_package_dependencies_posthog_node: string;
	...
	export const npm_config_ignore_workspace: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_package_dependencies_posthog_node: string;
		...
		SSL_CERT_DIR: string;
		npm_config_ignore_workspace: string;
		LANG: string;

...
declare module '$env/static/private' {
	...
	export const npm_config__tng_registry: string;
	...
	export const npm_config__tngtech_registry: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		TERM_PROGRAM: string;
		npm_config__tng_registry: string;
		FNM_LOGLEVEL: string;
		...
		PNPM_HOME: string;
		npm_config__tngtech_registry: string;

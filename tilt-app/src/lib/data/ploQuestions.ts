...
export const PLO_QUESTIONS: QuizQuestion[] = [
	...
	},
	{
		...
		answers: ['KKJ9 double-suited', 'JT98 double-suited', 'AAT2 rainbow', 'QQT9 single-suited'],
	...
	// Equity & Odds
	{
		...
		answers: ["85% (like in Hold'em)", '70%', '65%', '80%'],
		correctAnswer: '65%',
		explanation:
	...
	// Postflop Strategy
	{
		...
		answers: ['Full houses', 'Straights', 'Flushes', 'Two pair'],
	...
	},
	{
		...
		category: 'plo_postflop',
		difficulty: 'medium',
		question: 'You flop top set. Board: K73 rainbow. What is your main concern?',
		answers: [
	...
	},
	{
		...
		category: 'plo_postflop',
		difficulty: 'hard',
		question: 'Flop: AKQ (two spades). You have AKQ2 (no spades). Correct play?',
		answers: [
	...
	},
	{
		...
		category: 'plo_draws',
		difficulty: 'hard',
		question: 'You have JT98ds. Flop: Q76. How many clean outs?',
		answers: ['13 outs (wrap)', '17 outs (wrap + backdoors)', '20 outs', '8 outs'],
	...
	},
	{
		...
		answers: ['20-25% of hands', '10-15% of hands', '30% of hands', '5-10% of hands'],
	...
	// Blockers & GTO
	{
		...
		difficulty: 'hard',
		question: 'Board runs out KQJT2 (two spades). You have A987 (two diamonds). Correct play?',
		answers: [
	...
	// Bet Sizing
	{
		...
		answers: ['33% pot (like NLH)', '50-66% pot', '75-100% pot', '25% pot'],
	...
	},
	{
		...
		answers: ['Overbet pot (150%+)', 'Pot bet (100%)', 'Check - too polarized', 'Small bet (33%)'],
	...
	// Tournament PLO
	{
		...
		answers: ['Play tighter preflop', 'Play looser preflop', 'Same ranges', 'Only play AAxx'],
	...
	},
	{
		...
		answers: ['3-bet pot (commit 40% stack)', 'Call and see flop', '4-bet shove', 'Fold'],
	...
	},
	{
		...
		category: 'plo_mistakes',
		difficulty: 'medium',
		question: 'You hold KKxx. Flop comes AQ7 rainbow. What is the problem?',
		answers: [
	...
	// Additional Advanced PLO Questions
	{
		...
		answers: ['~2% equity edge', '~4-5% equity edge', '~8-10% equity edge', '~1% equity edge'],
	...
	},
	{
		...
		answers: ['JT98 double-suited', '8765 double-suited', 'T987 single-suited', '9876 rainbow'],
	...
	},
	{
		...
		category: 'plo_postflop',
		difficulty: 'hard',
		question: 'Monotone flop (K92 all spades), you have KKT8 (one spade). What is your strategy?',
		answers: [
	...
	},
	{
		...
		answers: ['Position', 'Hand strength', 'Stack depth', 'All equally important'],
